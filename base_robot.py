...
TIRE_DIAMETER = 61  # mm
AXLE_TRACK = 137  # distance between the wheels, mm
...
class BaseRobot:
    ...
    def __init__(self):
        ...
        self._version = "0.1 05/19/2024"
        self.leftDriveMotor = Motor(Port.A, Direction.COUNTERCLOCKWISE)
        self.rightDriveMotor = Motor(Port.B, Direction.CLOCKWISE)
        ...
        self.rightAttachmentMotor = Motor(Port.C, Direction.COUNTERCLOCKWISE)
        self.leftAttachmentMotor = Motor(Port.D, Direction.CLOCKWISE)
